...
hl.animation({ leaf = "workspacesIn", enabled = 1, speed = 1.21, bezier = "almostLinear", style="fade" })
hl.animation({ leaf = "workspacesOut", enabled = 1, speed = 1.94, bezier = "almostLinear", style= "fade" })
